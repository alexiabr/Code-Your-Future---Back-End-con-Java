            ...
            for (int j = 0; j < 10; j++) {
                if (matriz10[i][j] == matriz3[0][0]) {
                   ...
                   guardarValorColumna =j;
                    ...
                    for (contador1 = i; contador1 < matriz3.length; contador1++) {
                        int columnaMatrizCheck=0;
                        
                        for (contador2 = j; contador2 < matriz3.length; contador2++) {
                            matrizCheck[filaMatrizCheck][columnaMatrizCheck] = matriz10[contador1][contador2];
                            columnaMatrizCheck++;
                        }
                        filaMatrizCheck++;
                    }
                    for ( i=0; i<2; i++) {
                    for (j = 0; j<2; i++) {
                        System.out.println(matrizCheck[i][j]+", ");
                    }
                        System.out.println("\n");
                    }
